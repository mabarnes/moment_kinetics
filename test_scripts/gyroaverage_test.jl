...
function gyroaverage_test(;rhostar=0.1, pitch=0.5, ngrid=5, kr=2, kz=2, phaser=0.0, phasez=0.0, nelement=4, ngrid_vperp=3, nelement_vperp=1, Lvperp=3.0, ngrid_gyrophase=100, discretization="chebyshev_pseudospectral", r_bc="periodic", z_bc = "wall", plot_test_results=false)
        ...
        test_input = OptionsDict(
            "output"=>OptionsDict("run_name"=>"gyroaverages_test"),
        ...
        pdf, scratch, scratch_implicit, scratch_electron, t_params, vz, vr, vzeta, vpa,
            ...
            composition, collisions, geometry, gyroavs, boundaries,
        ...
        phi = fields.phi
        gphi = fields.gphi
        gphi_exact = allocate_float(vperp, z, r)
        ...
        pdf = allocate_shared_float(; vpa=vpa, vperp=vperp, z=z, r=r, ion_species=n_ion_species)
        gpdf = allocate_shared_float(; vpa=vpa, vperp=vperp, z=z, r=r, ion_species=n_ion_species)
        gpdf_exact = allocate_float(; vpa=vpa, vperp=vperp, z=z, r=r, ion_species=n_ion_species)
        gpdf_err = allocate_float(; vpa=vpa, vperp=vperp, z=z, r=r, ion_species=n_ion_species)
        @begin_serial_region()
        @serial_region begin
