...
In 2D, with a uniform magnetic field $\boldsymbol{B}$ and including 'anomalous
diffusion' in the radial direction, the ion kinetic equation for the
distribution function $f_i(t, \boldsymbol{r}, \boldsymbol{v})=f_i(t, r, z,
v_\parallel, v_\perp)$ is
```math
\begin{align}
...
In 2D, where there is no variation in the toroidal direction, the poloidal
electric field is $E_\mathrm{pol} = E_\parallel B_\mathrm{pol} / B$ and the
binormal electric field is then
$E_y = E_\mathrm{pol} B_\mathrm{tor} / B = E_\parallel B_\mathrm{pol} B_\mathrm{tor} / B^2$.
Similarly
$\partial f / \partial y = \partial f / \partial z B_\mathrm{pol} B_\mathrm{tor} / B^2$.
...
* continuity
  ...
  & \int \frac{\partial f_i}{\partial t} d^3 v
      + \underbrace{\int v_\parallel \frac{\partial f_i}{\partial z} d^3 v
                    + \frac{E_y}{B} \int \frac{\partial f_i}{\partial r} d^3 v
                    - \frac{E_r}{B} \int \frac{\partial f_i}{\partial y} d^3 v
                   }_\text{take derivatives out of velocity integrals}
  ...
  \begin{align}
  \frac{\partial n_i}{\partial t} + \frac{\partial}{\partial z}\left( n_i u_{i\parallel} \right)
        + \frac{\partial}{\partial r} \left( \frac{E_y}{B} n_i \right)
        - \frac{\partial}{\partial y} \left( \frac{E_r}{B} n_i \right)
      = R_\mathrm{ioniz} n_e n_n + S_{i,n} + D_r \frac{\partial^2 n_i}{\partial r^2} \\
  \end{align}
  ```
...
* momentum
  ...
  & \int v_\parallel \frac{\partial f_i}{\partial t} d^3 v
      ...
      + \frac{E_y}{B} \int v_\parallel \frac{\partial f_i}{\partial r} d^3 v
      - \frac{E_r}{B} \int v_\parallel \frac{\partial f_i}{\partial y} d^3 v
  ...
  & \frac{\partial}{\partial t} \int v_\parallel f_i d^3 v
      ...
      + \frac{E_y}{B} \frac{\partial}{\partial r} \int v_\parallel f_i d^3 v
      - \frac{E_r}{B} \frac{\partial}{\partial y} \int v_\parallel f_i d^3 v
  ...
  &\quad+ \frac{E_y}{B} \frac{\partial (n_i u_{i\parallel})}{\partial r}
      - \frac{E_r}{B} \frac{\partial (n_i u_{i\parallel})}{\partial y}
      + \frac{e}{m_i} \frac{\partial\phi}{\partial z} \int f_i d^3 v \nonumber \\
  &= \int v_\parallel \left[ -R_\mathrm{CX}(n_n f_i - n_i f_n) + R_\mathrm{ioniz} n_e f_n \right] d^3 v
      + \frac{1}{m_i} S_{i,\mathrm{mom}}
      + D_r \frac{\partial^2}{\partial r^2} \int v_\parallel f_i d^3 v \\
  ...
  & m_i \frac{\partial}{\partial t}(n_i u_{i\parallel})
    ...
    + m_i \frac{E_y}{B} \frac{\partial (n_i u_{i\parallel})}{\partial r}
    - m_i \frac{E_r}{B} \frac{\partial (n_i u_{i\parallel})}{\partial y}
  ...
  m_i u_{i\parallel} \frac{\partial n_i}{\partial t}
      ...
      + m_i u_{i\parallel} \frac{\partial}{\partial r} \left( \frac{E_y}{B} n_i \right)
      - m_i u_{i\parallel} \frac{\partial}{\partial y} \left( \frac{E_r}{B} n_i \right)
  ...
  &= - m_i n_i u_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z}
     ...
     - m_i u_{i\parallel} \frac{E_y}{B} \frac{\partial n_i}{\partial r}
     + m_i u_{i\parallel} \frac{E_r}{B} \frac{\partial n_i}{\partial y}
     + R_\mathrm{ioniz} m_i n_e n_n u_{i\parallel} + u_{i\parallel} S_{i,n}
     + m_i u_{i\parallel} D_r \frac{\partial^2 n_i}{\partial r^2} \\
  \end{align}
  ```
  ...
  &m_i u_{i\parallel} \frac{\partial n_i}{\partial t} + m_i n_i \frac{\partial u_{i\parallel}}{\partial t}
   ...
   + m_i \frac{E_y}{B} n_i \frac{\partial u_{i\parallel}}{\partial r}
   + m_i \frac{E_y}{B} u_{i\parallel} \frac{\partial n_i}{\partial r}
   - m_i \frac{E_r}{B} n_i \frac{\partial u_{i\parallel}}{\partial y}
   - m_i \frac{E_r}{B} u_{i\parallel} \frac{\partial n_i}{\partial y}
  ...
  &m_i n_i \frac{\partial u_{i\parallel}}{\partial t}
   + m_i n_i u_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z}
   + m_i n_i \frac{E_y}{B} \frac{\partial u_{i\parallel}}{\partial r}
   - m_i n_i \frac{E_r}{B} \frac{\partial u_{i\parallel}}{\partial y} \nonumber \\
  &= - \frac{\partial p_{i\parallel}}{\partial z} - e n_i \frac{\partial\phi}{\partial z}
     + R_\mathrm{CX} m_i n_i n_n (u_{n\parallel} - u_{i\parallel})
...
* Energy
  ...
  & \frac{3}{2} \int v^2 \frac{\partial f_i}{\partial t} d^3 v
      ...
      + \frac{3}{2} \frac{E_y}{B} \int v^2 \frac{\partial f_i}{\partial r} d^3 v
      - \frac{3}{2} \frac{E_r}{B} \int v^2 \frac{\partial f_i}{\partial y} d^3 v
  ...
  &\qquad + \underbrace{\frac{3}{2} \int v^2 S_i d^3 v}_{3 S_{i,E} / m_i}
          + \frac{3}{2} D_r \frac{\partial^2}{\partial r^2} \int v^2 f_i d^3 v \\

  & \frac{3}{2} \frac{\partial}{\partial t} \int v^2 f_i d^3 v
      + \frac{3}{2} \frac{\partial}{\partial z} \int v^2 v_\parallel f_i d^3 v
      + \frac{3}{2} \frac{E_y}{B} \frac{\partial}{\partial r} \int v^2 f_i d^3 v
      - \frac{3}{2} \frac{E_r}{B} \frac{\partial}{\partial y}\int v^2 f_i d^3 v
      + \frac{3}{2} \frac{e}{m_i} \frac{\partial\phi}{\partial z} \int 2 v_\parallel f_i d^3 v \nonumber \\
  &\quad= \frac{3}{2} \int v^2 \left[ -R_\mathrm{CX}(n_n f_i - n_i f_n) + R_\mathrm{ioniz} n_e f_n \right] d^3 v
          + \frac{3}{m_i} S_{i,E} \nonumber \\
  &\qquad + \frac{3}{2} D_r \frac{\partial^2}{\partial r^2} \int v^2 f_i d^3 v \\

  & \frac{3}{2} \frac{\partial}{\partial t} \int \left((v_\parallel - u_{i\parallel})^2 + \cancel{2(v_\parallel - u_{i\parallel}) u_{i\parallel}} + u_{i\parallel}^2 + v_\perp^2 \right) f_i d^3 v \nonumber \\
  ...
  &+ \frac{3}{2} \frac{E_y}{B} \frac{\partial}{\partial r} \int \left((v_\parallel - u_{i\parallel})^2 + \cancel{2(v_\parallel - u_{i\parallel}) u_{i\parallel}} + u_{i\parallel}^2 + v_\perp^2 \right) f_i d^3 v \nonumber \\
  &- \frac{3}{2} \frac{E_r}{B} \frac{\partial}{\partial y} \int \left((v_\parallel - u_{i\parallel})^2 + \cancel{2(v_\parallel - u_{i\parallel}) u_{i\parallel}} + u_{i\parallel}^2 + v_\perp^2 \right) f_i d^3 v \nonumber \\
  &+ \frac{3}{2} \frac{e}{m_i} \frac{\partial\phi}{\partial z} \int 2 \left( \cancel{(v_\parallel - u_{i\parallel})} + u_{i\parallel} \right) f_i d^3 v \nonumber \\
  &\quad= - \frac{3}{2} \int \left((v_\parallel - u_{i\parallel})^2 + \cancel{2(v_\parallel - u_{i\parallel}) u_{i\parallel}} + u_{i\parallel}^2 + v_\perp^2 \right) R_\mathrm{CX} n_n f_i d^3 v \nonumber \\
  &\qquad+ \frac{3}{2} \int \left((v_\parallel - u_{n\parallel})^2 + \cancel{2(v_\parallel - u_{n\parallel}) u_{n\parallel}} + u_{n\parallel}^2 + v_\perp^2 \right) R_\mathrm{CX} n_i f_n d^3 v \nonumber \\
  &\qquad+ \frac{3}{2} \int \left((v_\parallel - u_{n\parallel})^2 + \cancel{2(v_\parallel - u_{n\parallel}) u_{n\parallel}} + u_{n\parallel}^2 + v_\perp^2 \right) R_\mathrm{ioniz} n_e f_n d^3 v \nonumber \\
  &\qquad+ \frac{3}{m_i} S_{i,E} \nonumber \\
  ...
  & \frac{3}{2} \frac{\partial}{\partial t} \left( \frac{3 p_i}{m_i} + n_i u_{i\parallel}^2 \right) \nonumber \\
  &+ \frac{3}{2} \frac{\partial}{\partial z} \left[ \int \left( (v_\parallel - u_{i\parallel})^3 + v_\perp^2(v_\parallel - u_{i\parallel}) \right) f_i d^3 v + 2\frac{p_{i\parallel}}{m_i} u_{i\parallel} + \frac{3 p_i}{m_i} u_{i\parallel} + n_i u_{i\parallel}^3 \right] \nonumber \\
  &+ \frac{3}{2} \frac{E_y}{B} \frac{\partial}{\partial r} \left( \frac{3 p_i}{m_i} + n_i u_{i\parallel}^2 \right) \nonumber \\
  &- \frac{3}{2} \frac{E_r}{B} \frac{\partial}{\partial y} \left( \frac{3 p_i}{m_i} + n_i u_{i\parallel}^2 \right) \nonumber \\
  &+ 3 \frac{e}{m_i} \frac{\partial\phi}{\partial z} n_i u_{i\parallel} \nonumber \\
  &\quad= - \frac{3}{2} R_\mathrm{CX} \left(\frac{3 p_i}{m_i} n_n + n_i n_n u_{i\parallel}^2 - \frac{3 p_n}{m_i} n_i - n_i n_n u_{n\parallel}^2 \right) \nonumber \\
  &\qquad+ \frac{3}{2} R_\mathrm{ioniz} n_e \left(\frac{3 p_n}{m_i} + n_n u_{n\parallel}^2 \right) \nonumber \\
  &\qquad+ \frac{3}{m_i} S_{i,E} \nonumber \\
  &\qquad+ \frac{3}{2} D_r \frac{\partial^2}{\partial r^2} \left( \frac{3 p_i}{m_i} + n_i u_{i\parallel}^2 \right) \\

  & \frac{3}{2} \frac{\partial}{\partial t} \left( \frac{3 p_i}{m_i} + n_i u_{i\parallel}^2 \right)
    + \frac{3}{2} \frac{\partial}{\partial z} \left[ \frac{2 q_{i\parallel}}{m_i} + 2\frac{p_{i\parallel}}{m_i} u_{i\parallel} + \frac{3 p_i}{m_i} u_{i\parallel} + n_i u_{i\parallel}^3 \right] \nonumber \\
  &\quad+ \frac{3}{2} \frac{E_y}{B} \frac{\partial}{\partial r} \left( \frac{3 p_i}{m_i} + n_i u_{i\parallel}^2 \right)
    - \frac{3}{2} \frac{E_r}{B} \frac{\partial}{\partial y} \left( \frac{3 p_i}{m_i} + n_i u_{i\parallel}^2 \right)
    + 3 \frac{e}{m_i} \frac{\partial\phi}{\partial z} n_i u_{i\parallel} \nonumber \\
  &\quad= - \frac{3}{2} R_\mathrm{CX} \left(\frac{3 p_i}{m_i} n_n + n_i n_n u_{i\parallel}^2 - \frac{3 p_n}{m_i} n_i - n_i n_n u_{n\parallel}^2 \right)
        + \frac{3}{2} R_\mathrm{ioniz} n_e \left(\frac{3 p_n}{m_i} + n_n u_{n\parallel}^2 \right) \nonumber \\
  &\qquad+ \frac{3}{m_i} S_{i,E}
        + \frac{3}{2} D_r \frac{\partial^2}{\partial r^2} \left( \frac{3 p_i}{m_i} + n_i u_{i\parallel}^2 \right) \\

  & \frac{9}{2} \frac{\partial p_i}{\partial t} + 3 m_i u_{i\parallel} \frac{\partial(n_i u_{i\parallel})}{\partial t} - \frac{3}{2} m_i u_{i\parallel}^2 \frac{\partial n_i}{\partial t}
    + 3 \frac{\partial q_{i\parallel}}{\partial z} + 3 u_{i\parallel} \frac{\partial p_{i\parallel}}{\partial z} + 3 p_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z} \nonumber \\
  &\quad+ \frac{9}{2} u_{i\parallel} \frac{\partial p_i}{\partial z} + \frac{9}{2} p_i \frac{\partial u_{i\parallel}}{\partial z} + \frac{9}{2} m_i n_i u_{i\parallel}^2 \frac{\partial u_{i\parallel}}{\partial z} + \frac{3}{2} m_i u_{i\parallel}^3 \frac{\partial n_i}{\partial z} \nonumber \\
  &\quad+ \frac{9}{2} \frac{E_y}{B} \frac{\partial p_i}{\partial r} + \frac{3}{2} m_i \frac{E_y}{B} \frac{\partial (n_i u_{i\parallel}^2)}{\partial r}
    - \frac{9}{2} \frac{E_r}{B} \frac{\partial p_i}{\partial y} - \frac{3}{2} m_i \frac{E_r}{B} \frac{\partial (n_i u_{i\parallel}^2)}{\partial y}
    + 3 e \frac{\partial\phi}{\partial z} n_i u_{i\parallel} \nonumber \\
  &\quad= - \frac{3}{2} R_\mathrm{CX} \left(3 p_i n_n + m_i n_i n_n u_{i\parallel}^2 - 3 p_n n_i - m_i n_i n_n u_{n\parallel}^2 \right)
        + \frac{3}{2} R_\mathrm{ioniz} n_e \left(3 p_n + m_i n_n u_{n\parallel}^2 \right) \nonumber \\
  &\qquad+ \frac{3}{m_i} S_{i,E}
        + \frac{3}{2} D_r \left( 3 \frac{\partial^2 p_i}{\partial r^2} + m_i \frac{\partial^2 (n_i u_{i\parallel}^2)}{\partial r^2} \right) \\

  & \frac{9}{2} \frac{\partial p_i}{\partial t} \nonumber \\
  &\quad- 3 m_i u_{i\parallel} \frac{\partial}{\partial z}(n_i u_{i\parallel}^2) - 3 m_i u_{i\parallel} \frac{E_y}{B} \frac{\partial (n_i u_{i\parallel})}{\partial r} + 3 m_i u_{i\parallel} \frac{E_r}{B} \frac{\partial (n_i u_{i\parallel})}{\partial y} - 3 u_{i\parallel} \frac{\partial p_{i\parallel}}{\partial z} - 3 e n_i u_{i\parallel} \frac{\partial \phi}{\partial z} + 3 u_{i\parallel} R_\mathrm{CX} m_i n_i n_n (u_{n\parallel} - u_{i\parallel}) + 3 u_{i\parallel} R_\mathrm{ioniz} m_i n_e n_n u_{n\parallel} + 3 u_{i\parallel} S_{i,\mathrm{mom}} + 3 m_i u_{i\parallel} D_r \frac{\partial^2 (n_i u_{i\parallel})}{\partial r^2} \nonumber \\
  &\quad+ \frac{3}{2} m_i u_{i\parallel}^2 \frac{\partial}{\partial z}(n_i u_{i\parallel}) + \frac{3}{2} m_i u_{i\parallel}^2 \frac{\partial}{\partial r} \left( \frac{E_y}{B} n_i \right) - \frac{3}{2} m_i u_{i\parallel}^2 \frac{\partial}{\partial y} \left( \frac{E_r}{B} n_i \right) - \frac{3}{2} m_i u_{i\parallel}^2 R_\mathrm{ioniz} n_e n_n - \frac{3}{2} m_i u_{i\parallel}^2 S_{i,n} - \frac{3}{2} m_i u_{i\parallel}^2 D_r \frac{\partial^2 n_i}{\partial r^2} \nonumber \\
  &\quad+ 3 \frac{\partial q_{i\parallel}}{\partial z} + 3 u_{i\parallel} \frac{\partial p_{i\parallel}}{\partial z} + 3 p_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z} \nonumber \\
  &\quad+ \frac{9}{2} u_{i\parallel} \frac{\partial p_i}{\partial z} + \frac{9}{2} p_i \frac{\partial u_{i\parallel}}{\partial z} + \frac{9}{2} m_i n_i u_{i\parallel}^2 \frac{\partial u_{i\parallel}}{\partial z} + \frac{3}{2} m_i u_{i\parallel}^3 \frac{\partial n_i}{\partial z} \nonumber \\
  &\quad+ \frac{9}{2} \frac{E_y}{B} \frac{\partial p_i}{\partial r} + 3 m_i n_i u_{i\parallel} \frac{E_y}{B} \frac{\partial u_{i\parallel}}{\partial r} + \frac{3}{2} m_i u_{i\parallel}^2 \frac{E_y}{B} \frac{\partial n_i}{\partial r}
    - \frac{9}{2} \frac{E_r}{B} \frac{\partial p_i}{\partial y} - 3 m_i n_i u_{i\parallel} \frac{E_r}{B} \frac{\partial u_{i\parallel}}{\partial y} - \frac{3}{2} m_i u_{i\parallel}^2 \frac{E_r}{B} \frac{\partial n_i}{\partial y}
    + 3 e \frac{\partial\phi}{\partial z} n_i u_{i\parallel} \nonumber \\
  &\quad= - \frac{3}{2} R_\mathrm{CX} \left(3 p_i n_n + m_i n_i n_n u_{i\parallel}^2 - 3 p_n n_i - m_i n_i n_n u_{n\parallel}^2 \right)
        + \frac{3}{2} R_\mathrm{ioniz} n_e \left(3 p_n + m_i n_n u_{n\parallel}^2 \right) \nonumber \\
  &\qquad+ 3 S_{i,E}
  ...
  & \frac{9}{2} \frac{\partial p_i}{\partial t} \nonumber \\
  &\quad- \cancel{6 m_i n_i u_{i\parallel}^2 \frac{\partial u_{i\parallel}}{\partial z}} - \cancel{3 m_i u_{i\parallel}^3 \frac{\partial n_i}{\partial z}} - \cancel{3 m_i n_i u_{i\parallel} \frac{E_y}{B} \frac{\partial u_{i\parallel}}{\partial r}} - \cancel{3 m_i u_{i\parallel}^2 \frac{E_y}{B} \frac{\partial n_i}{\partial r}} + \cancel{3 m_i n_i u_{i\parallel} \frac{E_r}{B} \frac{\partial u_{i\parallel}}{\partial y}} + \cancel{3 m_i u_{i\parallel}^2 \frac{E_r}{B} \frac{\partial n_i}{\partial y}} - \cancel{3 u_{i\parallel} \frac{\partial p_{i\parallel}}{\partial z}} - \cancel{3 e n_i u_{i\parallel} \frac{\partial \phi}{\partial z}} + 3 u_{i\parallel} R_\mathrm{CX} m_i n_i n_n (u_{n\parallel} - u_{i\parallel}) + 3 u_{i\parallel} R_\mathrm{ioniz} m_i n_e n_n u_{n\parallel} + 3 u_{i\parallel} S_{i,\mathrm{mom}} + \cancel{3 m_i u_{i\parallel} D_r \frac{\partial^2 (n_i u_{i\parallel})}{\partial r^2}} \nonumber \\
  &\quad+ \cancel{\frac{3}{2} m_i n_i u_{i\parallel}^2 \frac{\partial u_{i\parallel}}{\partial z}} + \cancel{\frac{3}{2} m_i u_{i\parallel}^3 \frac{\partial n_i}{\partial z}} + \cancel{\frac{3}{2} m_i u_{i\parallel}^2 \frac{E_y}{B} \frac{\partial n_i}{\partial r}} - \cancel{\frac{3}{2} m_i u_{i\parallel}^2 \frac{E_r}{B} \frac{\partial n_i}{\partial y}} - \frac{3}{2} m_i u_{i\parallel}^2 R_\mathrm{ioniz} n_e n_n - \frac{3}{2} m_i u_{i\parallel}^2 S_{i,n} - \cancel{\frac{3}{2} m_i u_{i\parallel}^2 D_r \frac{\partial^2 n_i}{\partial r^2}} \nonumber \\
  &\quad+ 3 \frac{\partial q_{i\parallel}}{\partial z} + \cancel{3 u_{i\parallel} \frac{\partial p_{i\parallel}}{\partial z}} + 3 p_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z} \nonumber \\
  &\quad+ \frac{9}{2} u_{i\parallel} \frac{\partial p_i}{\partial z} + \frac{9}{2} p_i \frac{\partial u_{i\parallel}}{\partial z} + \cancel{\frac{9}{2} m_i n_i u_{i\parallel}^2 \frac{\partial u_{i\parallel}}{\partial z}} + \cancel{\frac{3}{2} m_i u_{i\parallel}^3 \frac{\partial n_i}{\partial z}} \nonumber \\
  &\quad+ \frac{9}{2} \frac{E_y}{B} \frac{\partial p_i}{\partial r} + \cancel{3 m_i n_i u_{i\parallel} \frac{E_y}{B} \frac{\partial u_{i\parallel}}{\partial r}} + \cancel{\frac{3}{2} m_i u_{i\parallel}^2 \frac{E_y}{B} \frac{\partial n_i}{\partial r}}
    - \frac{9}{2} \frac{E_r}{B} \frac{\partial p_i}{\partial y} - \cancel{3 m_i n_i u_{i\parallel} \frac{E_r}{B} \frac{\partial u_{i\parallel}}{\partial y}} - \cancel{\frac{3}{2} m_i u_{i\parallel}^2 \frac{E_r}{B} \frac{\partial n_i}{\partial y}}
    + \cancel{3 e \frac{\partial\phi}{\partial z} n_i u_{i\parallel}} \nonumber \\
  &\quad= - \frac{3}{2} R_\mathrm{CX} \left(3 p_i n_n + m_i n_i n_n u_{i\parallel}^2 - 3 p_n n_i - m_i n_i n_n u_{n\parallel}^2 \right)
        + \frac{3}{2} R_\mathrm{ioniz} n_e \left(3 p_n + m_i n_n u_{n\parallel}^2 \right) \nonumber \\
  &\qquad+ 3 S_{i,E}
  ...
  & \frac{9}{2} \frac{\partial p_i}{\partial t}
    + 3 \frac{\partial q_{i\parallel}}{\partial z} + 3 p_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z}
    + \frac{9}{2} u_{i\parallel} \frac{\partial p_i}{\partial z} + \frac{9}{2} p_i \frac{\partial u_{i\parallel}}{\partial z}
    + \frac{9}{2} \frac{E_y}{B} \frac{\partial p_i}{\partial r} - \frac{9}{2} \frac{E_r}{B} \frac{\partial p_i}{\partial y} \nonumber \\
  &\quad= - \frac{3}{2} R_\mathrm{CX} \left(3 p_i n_n - m_i n_i n_n u_{i\parallel}^2 + 2 m_i n_i n_n u_{i\parallel}u_{n\parallel} - 3 p_n n_i - m_i n_i n_n u_{n\parallel}^2 \right)
        + \frac{3}{2} R_\mathrm{ioniz} n_e \left(3 p_n + m_i n_n u_{i\parallel}^2 - 2 m_i n_n u_{i\parallel} u_{n\parallel} + m_i n_n u_{n\parallel}^2 \right) \nonumber \\
  &\qquad+ 3 S_{i,E}
         - 3 u_{i\parallel} S_{i,\mathrm{mom}}
         + \frac{3}{2} m_i u_{i\parallel}^2 S_{i,n}
  ...
  & \frac{3}{2} \frac{\partial p_i}{\partial t}
    ...
    + \frac{3}{2} \frac{E_y}{B} \frac{\partial p_i}{\partial r} - \frac{3}{2} \frac{E_r}{B} \frac{\partial p_i}{\partial y} \nonumber \\
  ...
  & \frac{3}{2} \frac{\partial n_i T_i}{\partial t}
    ...
    + \frac{3}{2} \frac{E_y}{B} \frac{\partial n_i T_i}{\partial r} - \frac{3}{2} \frac{E_r}{B} \frac{\partial n_i T_i}{\partial y} \nonumber \\
  &\quad= - \frac{1}{2} R_\mathrm{CX} n_i n_n \left(3 T_i - 3 T_n - m_i (u_{i\parallel} - u_{n\parallel})^2 \right)
        + \frac{1}{2} R_\mathrm{ioniz} n_e n_n \left(3 T_n + m_i (u_{i\parallel} - u_{n\parallel})^2 \right) \nonumber \\
  &\qquad+ \frac{3}{2} S_{i,p}
  ...
  & \frac{3}{2} n_i \frac{\partial T_i}{\partial t} + \frac{3}{2} T_i \frac{\partial n_i}{\partial t}
    ...
    + \frac{3}{2} n_i \frac{E_y}{B} \frac{\partial T_i}{\partial r} + \frac{3}{2} T_i \frac{E_y}{B} \frac{\partial n_i}{\partial r} - \frac{3}{2} n_i \frac{E_r}{B} \frac{\partial T_i}{\partial y} - \frac{3}{2} T_i \frac{E_r}{B} \frac{\partial n_i}{\partial y} \nonumber \\
  &\quad= - \frac{1}{2} R_\mathrm{CX} n_i n_n \left(3 T_i - 3 T_n - m_i (u_{i\parallel} - u_{n\parallel})^2 \right)
        + \frac{1}{2} R_\mathrm{ioniz} n_e n_n \left(3 T_n + m_i (u_{i\parallel} - u_{n\parallel})^2 \right) \nonumber \\
  &\qquad+ \frac{3}{2} S_{i,p}
  ...
  & \frac{3}{2} n_i \frac{\partial T_i}{\partial t}
    - \frac{3}{2} n_i T_i \frac{\partial u_{i\parallel}}{\partial z} - \frac{3}{2} u_{i\parallel} T_i \frac{\partial n_i}{\partial z} - \frac{3}{2} T_i \frac{E_y}{B} \frac{\partial n_i}{\partial r} + \frac{3}{2} T_i \frac{E_r}{B} \frac{\partial n_i}{\partial y} + \frac{3}{2} T_i R_\mathrm{ioniz} n_e n_n + \frac{3}{2} T_i S_{i,n} + \frac{3}{2} T_i D_r \frac{\partial^2 n_i}{\partial r^2} \nonumber \\
  & + \frac{\partial q_{i\parallel}}{\partial z} + p_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z}
    + \frac{3}{2} n_i u_{i\parallel} \frac{\partial T_i}{\partial z} + \frac{3}{2} u_{i\parallel} T_i \frac{\partial n_i}{\partial z} + \frac{3}{2} n_i T_i \frac{\partial u_{i\parallel}}{\partial z}
    + \frac{3}{2} n_i \frac{E_y}{B} \frac{\partial T_i}{\partial r} + \frac{3}{2} T_i \frac{E_y}{B} \frac{\partial n_i}{\partial r} - \frac{3}{2} n_i \frac{E_r}{B} \frac{\partial T_i}{\partial y} - \frac{3}{2} T_i \frac{E_r}{B} \frac{\partial n_i}{\partial y} \nonumber \\
  &\quad= - \frac{1}{2} R_\mathrm{CX} n_i n_n \left(3 T_i - 3 T_n - m_i (u_{i\parallel} - u_{n\parallel})^2 \right)
  ...
  & \frac{3}{2} n_i \frac{\partial T_i}{\partial t}
    ...
    + \frac{3}{2} n_i \frac{E_y}{B} \frac{\partial T_i}{\partial r} - \frac{3}{2} n_i \frac{E_r}{B} \frac{\partial T_i}{\partial y} \nonumber \\
  &\quad= - \frac{1}{2} R_\mathrm{CX} n_i n_n \left(3 T_i - 3 T_n - m_i (u_{i\parallel} - u_{n\parallel})^2 \right)
  ...
  \frac{\partial T_i}{\partial y} &= \frac{1}{2} m_i \frac{\partial v_{Ti}^2}{\partial y} \nonumber \\
  &= m_i v_{Ti} \frac{\partial v_{Ti}}{\partial y} \\
  \end{align}
  ```
  ```math
  \begin{align}
  & \frac{3}{2} m_i n_i v_{Ti} \frac{\partial v_{Ti}}{\partial t}
    ...
    + \frac{3}{2} m_i n_i v_{Ti} \frac{E_y}{B} \frac{\partial v_{Ti}}{\partial r} - \frac{3}{2} m_i n_i v_{Ti} \frac{E_r}{B} \frac{\partial v_{Ti}}{\partial y} \nonumber \\
  &\quad= - \frac{1}{2} R_\mathrm{CX} n_i n_n \left(3 T_i - 3 T_n - m_i (u_{i\parallel} - u_{n\parallel})^2 \right)
        + \frac{1}{2} R_\mathrm{ioniz} n_e n_n \left(3 T_n - 3 T_i + m_i (u_{i\parallel} - u_{n\parallel})^2 \right) \nonumber \\
  &\qquad+ \frac{3}{2} S_{i,p} - \frac{3}{2} T_i S_{i,n} \\
  \end{align}
  ...
  ```math
  \begin{align}
  & \frac{3}{2} m_i n_i v_{Ti} \left( \frac{\partial v_{Ti}}{\partial t} + u_{i\parallel} \frac{\partial v_{Ti}}{\partial z} + \frac{E_y}{B} \frac{\partial v_{Ti}}{\partial r} - \frac{E_r}{B} \frac{\partial v_{Ti}}{\partial y} \right) \nonumber \\
...
& \frac{\partial n_i F_i}{\partial t} + v_\parallel \frac{\partial n_i F_i}{\partial z}
    + \frac{E_y}{B} \frac{\partial n_i F_i}{\partial r}
    - \frac{E_r}{B} \frac{\partial n_i F_i}{\partial y}
...
& n_i \frac{\partial F_i}{\partial t} + F_i \frac{\partial n_i}{\partial t} + n_i v_\parallel \frac{\partial F_i}{\partial z} + v_\parallel F_i \frac{\partial n_i}{\partial z}
    + \frac{E_y}{B} n_i \frac{\partial F_i}{\partial r} + \frac{E_y}{B} \frac{\partial n_i}{\partial r} F_i
    - \frac{E_r}{B} n_i \frac{\partial F_i}{\partial y} - \frac{E_r}{B} \frac{\partial n_i}{\partial y} F_i
...
& n_i \frac{\partial F_i}{\partial t} - F_i n_i \frac{\partial u_{i\parallel}}{\partial z} - F_i u_{i\parallel} \frac{\partial n_i}{\partial z} - F_i \frac{E_y}{B} \frac{\partial n_i}{\partial r} + \frac{E_r}{B} \frac{\partial n_i}{\partial y} + F_i R_\mathrm{ioniz} n_e n_n + F_i S_{i,n} + F_i D_r \frac{\partial^2 n_i}{\partial r^2} + n_i v_\parallel \frac{\partial F_i}{\partial z} + v_\parallel F_i \frac{\partial n_i}{\partial z}
    + \frac{E_y}{B} n_i \frac{\partial F_i}{\partial r} + \frac{E_y}{B} \frac{\partial n_i}{\partial r} F_i
    - \frac{E_r}{B} n_i \frac{\partial F_i}{\partial y} - \frac{E_r}{B} \frac{\partial n_i}{\partial y} F_i
    - n_i \frac{e}{m_i} \frac{\partial\phi}{\partial z} \frac{\partial F_i}{\partial v_\parallel} \nonumber \\
&\quad= C_{ii}[n_i F_i, n_i F_i] - R_\mathrm{CX} n_i n_n (F_i - F_n) + R_\mathrm{ioniz} n_e n_n F_n + S_i
...
\begin{align}
& \frac{\partial F_i}{\partial t} + v_\parallel \frac{\partial F_i}{\partial z}
  + \left( \frac{E_y}{B} - \frac{2 D_r}{n_i} \frac{\partial n_i}{\partial r} \right) \frac{\partial F_i}{\partial r} - \frac{E_r}{B} \frac{\partial F_i}{\partial y}
  - \frac{e}{m_i} \frac{\partial\phi}{\partial z} \frac{\partial F_i}{\partial v_\parallel} \nonumber \\
...
&\left. \frac{\partial f_i}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp}
    + v_\parallel \left. \frac{\partial f_i}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp}
    + \frac{E_y}{B} \left. \frac{\partial f_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp}
    - \frac{E_r}{B} \left. \frac{\partial f_i}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp}
    - \frac{e}{m_i} \frac{\partial\phi}{\partial z} \left. \frac{\partial f_i}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp} \nonumber \\
...
\begin{align}
\left. \frac{\partial f_i}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp}
  &= \left. \frac{\partial}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp} \left(\frac{n_i F_i}{v_{Ti}^3}\right) \nonumber \\
  &= \left. \frac{\partial n_i}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp} \frac{F_i}{v_{Ti}^3}
     - 3 \left. \frac{\partial v_{Ti}}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp} \frac{n_i F_i}{v_{Ti}^4}
     + \frac{n_i}{v_{Ti}^3} \left. \frac{\partial F_i}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp} \\

v_\parallel \left. \frac{\partial f_i}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp}
  &= v_\parallel \left. \frac{\partial}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp} \left(\frac{n_i F_i}{v_{Ti}^3}\right) \nonumber \\
  &= v_\parallel \left. \frac{\partial n_i}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp} \frac{F_i}{v_{Ti}^3}
     - 3 v_\parallel \left. \frac{\partial v_{Ti}}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp} \frac{n_i F_i}{v_{Ti}^4}
     + v_\parallel \frac{n_i}{v_{Ti}^3} \left. \frac{\partial F_i}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp} \\

\frac{E_y}{B} \left. \frac{\partial f_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \nonumber \\
  &= \frac{E_y}{B} \left. \frac{\partial}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left( \frac{n_i F_i}{v_{Ti}^3} \right) \nonumber \\
  &= \frac{E_y}{B} \left. \frac{\partial n_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \frac{F_i}{v_{Ti}^3}
     - 3 \frac{E_y}{B} \left. \frac{\partial v_{Ti}}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \frac{n_i F_i}{v_{Ti}^4}
     + \frac{E_y}{B} \frac{n_i}{v_{Ti}^3} \left. \frac{\partial F_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \\

\frac{E_r}{B} \left. \frac{\partial f_i}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp} \nonumber \\
  &= \frac{E_r}{B} \left. \frac{\partial}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp} \left( \frac{n_i F_i}{v_{Ti}^3} \right) \nonumber \\
  &= \frac{E_r}{B} \left. \frac{\partial n_i}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp} \frac{F_i}{v_{Ti}^3}
     - 3 \frac{E_r}{B} \left. \frac{\partial v_{Ti}}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp} \frac{n_i F_i}{v_{Ti}^4}
     + \frac{E_r}{B} \frac{n_i}{v_{Ti}^3} \left. \frac{\partial F_i}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp} \\

\frac{e}{m_i} \frac{\partial \phi}{\partial z} \left. \frac{\partial f_i}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp}
  &= \frac{e}{m_i} \frac{\partial \phi}{\partial z} \left. \frac{\partial}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp} \left(\frac{n_i F_i}{v_{Ti}^3}\right) \nonumber \\
  &= \frac{e n_i}{m_i v_{Ti}^3} \frac{\partial \phi}{\partial z} \left. \frac{\partial F_i}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp} \\
...
D_r \left. \frac{\partial^2 f_i}{\partial r^2} \right|_{t,y,z,v_\parallel,v_\perp}
  ...
  &= D_r \left. \frac{\partial^2 n_i}{\partial r^2} \right|_{t,y,z,v_\parallel,v_\perp} \frac{F_i}{v_{Ti}^3}
     ...
     + D_r \frac{1}{v_{Ti}^3} \left. \frac{\partial n_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left. \frac{\partial F_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \nonumber \\
...
&\quad+ D_r \frac{1}{v_{Ti}^3} \left. \frac{\partial n_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left. \frac{\partial F_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp}
  ...
  &= D_r \left. \frac{\partial^2 n_i}{\partial r^2} \right|_{t,y,z,v_\parallel,v_\perp} \frac{F_i}{v_{Ti}^3}
     - 6 D_r \left. \frac{\partial n_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left. \frac{\partial v_{Ti}}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \frac{F_i}{v_{Ti}^4}
     + 2 D_r \frac{1}{v_{Ti}^3} \left. \frac{\partial n_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left. \frac{\partial F_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \nonumber \\
&\quad- 3 D_r \left. \frac{\partial^2 v_{Ti}}{\partial r^2} \right|_{t,y,z,v_\parallel,v_\perp} \frac{n_i F_i}{v_{Ti}^4}
     + 12 D_r \left( \left. \frac{\partial v_{Ti}}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \right)^2 \frac{n_i F_i}{v_{Ti}^5}
     - 6 D_r \frac{n_i}{v_{Ti}^4} \left. \frac{\partial v_{Ti}}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left. \frac{\partial F_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \nonumber \\
&\quad+ D_r \frac{n_i}{v_{Ti}^3} \left. \frac{\partial^2 F_i}{\partial r^2} \right|_{t,y,z,v_\parallel,v_\perp} \\
\end{align}
```
...
&\frac{n_i}{v_{Ti}^3} \left. \frac{\partial F_i}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp}
    + v_\parallel \frac{n_i}{v_{Ti}^3} \left. \frac{\partial F_i}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp}
    + \left( \frac{E_y}{B} \frac{n_i}{v_{Ti}^3}
             - D_r \frac{1}{v_{Ti}^3} \frac{\partial n_i}{\partial r}
             + 3 D_r \frac{n_i}{v_{Ti}^4} \frac{\partial v_{Ti}}{\partial r}
             - D_r \frac{1}{v_{Ti}^3} \frac{\partial n_i}{\partial r}
             + 3 D_r \frac{n_i}{v_{Ti}^4} \frac{\partial v_{Ti}}{\partial r}
      \right) \left. \frac{\partial F_i}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp}
    - \frac{E_r}{B} \frac{n_i}{v_{Ti}^3} \left. \frac{\partial F_i}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp}
    - \frac{e n_i}{m_i v_{Ti}^3} \frac{\partial\phi}{\partial z} \left. \frac{\partial F_i}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp} \nonumber \\
    &\quad + \left( \frac{1}{v_{Ti}^3} \frac{\partial n_i}{\partial t} - \frac{3 n_i}{v_{Ti}^4} \frac{\partial v_{Ti}}{\partial t}
                    + \frac{v_\parallel}{v_{Ti}^3} \frac{\partial n_i}{\partial z} - \frac{3 v_\parallel n_i}{v_{Ti}^4} \frac{\partial v_{Ti}}{\partial z}
                    + \frac{E_y}{B} \frac{1}{v_{Ti}^3} \frac{\partial n_i}{\partial r} - 3 \frac{E_y}{B} \frac{n_i}{v_{Ti}^4} \frac{\partial v_{Ti}}{\partial r}
                    - \frac{E_r}{B} \frac{1}{v_{Ti}^3} \frac{\partial n_i}{\partial y} + 3 \frac{E_r}{B} \frac{n_i}{v_{Ti}^4} \frac{\partial v_{Ti}}{\partial y}
                    - D_r \frac{\partial^2 n_i}{\partial r^2} \frac{1}{v_{Ti}^3}
                    + 6 D_r \frac{\partial n_i}{\partial r} \frac{\partial v_{Ti}}{\partial r} \frac{1}{v_{Ti}^4}
                    + 3 D_r \frac{\partial^2 v_{Ti}}{\partial r^2} \frac{n_i}{v_{Ti}^4}
                    - 12 D_r \left( \frac{\partial v_{Ti}}{\partial r} \right)^2 \frac{n_i}{v_{Ti}^5}
             \right) F_i \nonumber \\
...
&\left. \frac{\partial F_i}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp}
    ...
    - \frac{E_r}{B} \left. \frac{\partial F_i}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp}
    - \frac{e}{m_i} \frac{\partial\phi}{\partial z} \left. \frac{\partial F_i}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp} \nonumber \\
    &\quad + \left( \frac{1}{n_i} \frac{\partial n_i}{\partial t} - \frac{3}{v_{Ti}} \frac{\partial v_{Ti}}{\partial t}
                    + \frac{v_\parallel}{n_i} \frac{\partial n_i}{\partial z} - \frac{3 v_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial z}
                    + \frac{E_y}{B} \frac{1}{n_i} \frac{\partial n_i}{\partial r} - 3 \frac{E_y}{B} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                    - \frac{E_r}{B} \frac{1}{n_i} \frac{\partial n_i}{\partial y} + 3 \frac{E_r}{B} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y}
                    - D_r \frac{1}{n_i} \frac{\partial^2 n_i}{\partial r^2}
...
\begin{align}
\left. \frac{\partial}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp}
  &= \left. \frac{\partial t}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial t} \right|_{r,y,z,w_\parallel,w_\perp}
    + \left. \frac{\partial z}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial z} \right|_{t,r,y,w_\parallel,w_\perp}
    + \left. \frac{\partial w_\parallel}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial w_\parallel} \right|_{t,r,y,z,w_\perp}
    + \left. \frac{\partial w_\perp}{\partial t} \right|_{r,y,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial w_\perp} \right|_{t,r,y,z,w_\parallel} \\
...
\left. \frac{\partial}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp}
  &= \left. \frac{\partial t}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp} \left. \frac{\partial}{\partial t} \right|_{r,y,z,w_\parallel,w_\perp}
    + \left. \frac{\partial z}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp} \left. \frac{\partial}{\partial z} \right|_{t,r,y,w_\parallel,w_\perp}
    + \left. \frac{\partial w_\parallel}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp} \left. \frac{\partial}{\partial w_\parallel} \right|_{t,r,y,z,w_\perp}
    + \left. \frac{\partial w_\perp}{\partial z} \right|_{t,r,y,v_\parallel,v_\perp} \left. \frac{\partial}{\partial w_\perp} \right|_{t,r,y,z,w_\parallel} \\
...
\left. \frac{\partial}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp}
  &= \left. \frac{\partial t}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial t} \right|_{r,y,z,w_\parallel,w_\perp}
    + \left. \frac{\partial z}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial z} \right|_{t,r,y,w_\parallel,w_\perp}
    + \left. \frac{\partial w_\parallel}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial w_\parallel} \right|_{t,r,y,z,w_\perp}
    + \left. \frac{\partial w_\perp}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial w_\perp} \right|_{t,r,y,z,w_\parallel} \\
...
\left. \frac{\partial}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp}
  &= \left. \frac{\partial t}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial t} \right|_{r,y,z,w_\parallel,w_\perp}
    + \left. \frac{\partial z}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial z} \right|_{t,r,y,w_\parallel,w_\perp}
    + \left. \frac{\partial w_\parallel}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial w_\parallel} \right|_{t,r,y,z,w_\perp}
    + \left. \frac{\partial w_\perp}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp} \left. \frac{\partial}{\partial w_\perp} \right|_{t,r,y,z,w_\parallel} \\
  &= \frac{\partial}{\partial y}
    + \left( -\frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial y} - \frac{(v_\parallel - u_{i\parallel})}{v_{Ti}^2} \frac{\partial v_{Ti}}{\partial y} \right) \frac{\partial}{\partial w_\parallel}
    - \frac{v_\perp}{v_{Ti}^2} \frac{\partial v_{Ti}}{\partial y} \frac{\partial}{\partial w_\perp} \\
  &= \frac{\partial}{\partial y}
    + \left( -\frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial y} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y} \right) \frac{\partial}{\partial w_\parallel}
    - \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y} \frac{\partial}{\partial w_\perp} \\

\left. \frac{\partial}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp}
  &= \left. \frac{\partial t}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp} \left. \frac{\partial}{\partial t} \right|_{r,y,z,w_\parallel,w_\perp}
    + \left. \frac{\partial z}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp} \left. \frac{\partial}{\partial z} \right|_{t,r,y,w_\parallel,w_\perp}
    + \left. \frac{\partial w_\parallel}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp} \left. \frac{\partial}{\partial w_\parallel} \right|_{t,r,y,z,w_\perp}
    + \left. \frac{\partial w_\perp}{\partial v_\parallel} \right|_{t,r,y,z,v_\perp} \left. \frac{\partial}{\partial w_\perp} \right|_{t,r,y,z,w_\parallel} \\
  &= \frac{1}{v_{Ti}} \frac{\partial}{\partial w_\parallel} \\

\left. \frac{\partial}{\partial v_\perp} \right|_{t,r,y,z,v_\parallel}
  &= \left. \frac{\partial t}{\partial v_\perp} \right|_{t,r,y,z,v_\parallel} \left. \frac{\partial}{\partial t} \right|_{r,y,z,w_\parallel,w_\perp}
    + \left. \frac{\partial z}{\partial v_\perp} \right|_{t,r,y,z,v_\parallel} \left. \frac{\partial}{\partial z} \right|_{t,r,y,w_\parallel,w_\perp}
    + \left. \frac{\partial w_\parallel}{\partial v_\perp} \right|_{t,r,y,z,v_\parallel} \left. \frac{\partial}{\partial w_\parallel} \right|_{t,r,y,z,w_\perp}
    + \left. \frac{\partial w_\perp}{\partial v_\perp} \right|_{t,r,y,z,v_\parallel} \left. \frac{\partial}{\partial w_\perp} \right|_{t,r,y,z,w_\parallel} \\
...
&\frac{\partial F_i}{\partial t} 
    ...
    &\quad + \left( \frac{E_y}{B}
                    - D_r \frac{1}{n_i} \frac{\partial n_i}{\partial r}
                    + 3 D_r \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                    - D_r \frac{1}{n_i} \frac{\partial n_i}{\partial r}
                    + 3 D_r \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
             \right) \frac{\partial F_i}{\partial r} \nonumber \\
    &\quad + \left( \frac{E_y}{B}
                    - D_r \frac{1}{n_i} \frac{\partial n_i}{\partial r}
                    + 3 D_r \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                    - D_r \frac{1}{n_i} \frac{\partial n_i}{\partial r}
                    + 3 D_r \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
             \right) \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right) \frac{\partial F_i}{\partial w_\parallel} \nonumber \\
    &\quad - \left( \frac{E_y}{B}
                    - D_r \frac{1}{n_i} \frac{\partial n_i}{\partial r}
                    + 3 D_r \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                    - D_r \frac{1}{n_i} \frac{\partial n_i}{\partial r}
                    + 3 D_r \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
             \right) \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{\partial F_i}{\partial w_\perp} \nonumber \\
    &\quad - \frac{E_r}{B} \frac{\partial F_i}{\partial y}
           - \frac{E_r}{B} \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial y} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y} \right) \frac{\partial F_i}{\partial w_\parallel}
           + \frac{E_r}{B} \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y} \frac{\partial F_i}{\partial w_\perp} \nonumber \\
    ...
    &\quad= \frac{v_{Ti}^3}{n_i} C_{ii}[\frac{n_i F_i}{v_{Ti}^3}, \frac{n_i F_i}{v_{Ti}^3}] - R_\mathrm{CX} n_n \left( F_i - \frac{v_{Ti}^3}{v_{Tn}^3} F_n \right) + R_\mathrm{ioniz} \frac{n_e n_n}{n_i} \frac{v_{Ti}^3}{v_{Tn}^3} F_n + \frac{v_{Ti}^3}{n_i} S_i \nonumber \\
    &\qquad + D_r \frac{\partial^2 F_i}{\partial r^2}
            + D_r \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right) \frac{\partial^2 F_i}{\partial r \partial w_\parallel} \nonumber \\
    &\qquad + D_r \left( - \frac{1}{v_{Ti}} \frac{\partial^2 u_{i\parallel}}{\partial r^2}
                  ...
                  \right) \frac{\partial F_i}{\partial w_\parallel} \nonumber \\
    &\qquad - D_r \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{\partial^2 F_i}{\partial r \partial w_\perp} \nonumber \\
    &\qquad + D_r \left( - \frac{w_\perp}{v_{Ti}} \frac{\partial^2 v_{Ti}}{\partial r^2}
                         + \frac{w_\perp}{v_{Ti}^2} \left( \frac{\partial v_{Ti}}{\partial r} \right)^2
                  \right) \frac{\partial F_i}{\partial w_\perp} \nonumber \\
    &\qquad + D_r \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right) \frac{\partial^2 F_i}{\partial r \partial w_\parallel} \nonumber \\
    &\qquad + D_r \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right)^2 \frac{\partial^2 F_i}{\partial w_\parallel^2} \nonumber \\
    &\qquad - D_r \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right) \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{\partial F_i}{\partial w_\parallel} \nonumber \\
    &\qquad - D_r \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right) \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{\partial^2 F_i}{\partial w_\parallel \partial w_\perp} \nonumber \\
    &\qquad - D_r \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{\partial^2 F_i}{\partial r \partial w_\perp} \nonumber \\
    &\qquad - D_r \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right)  \frac{\partial^2 F_i}{\partial w_\parallel \partial w_\perp} \nonumber \\
    &\qquad + D_r \left( \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right)^2 \frac{\partial^2 F_i}{\partial w_\perp^2} \nonumber \\
    &\qquad + D_r \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{\partial F_i}{\partial w_\perp} \\
\end{align}
```
```@raw html
</details>
...
&\frac{\partial F_i}{\partial t} + (v_{Ti} w_\parallel + u_{i\parallel}) \frac{\partial F_i}{\partial z} \nonumber \\
    ...
    &\qquad\quad + \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial t} + w_\parallel \left( w_\parallel + \frac{u_{i\parallel}}{v_{Ti}} \right) \frac{\partial v_{Ti}}{\partial z} \nonumber \\
    ...
    &\qquad\quad + D_r \left( - \frac{1}{v_{Ti}} \frac{\partial^2 u_{i\parallel}}{\partial r^2}
                              ...
                              + \frac{w_\parallel}{v_{Ti}^2} \left( \frac{\partial v_{Ti}}{\partial r} \right)^2
                       \right) \nonumber \\
    &\qquad\quad\left. - D_r \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right) \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
             \right] \frac{\partial F_i}{\partial w_\parallel} \nonumber \\
    &\quad - \left[ \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial t} + \left( w_\parallel + \frac{u_{i\parallel}}{v_{Ti}} \right) w_\perp \frac{\partial v_{Ti}}{\partial z} \right . \nonumber \\
    &\qquad\quad + \left( \frac{E_y}{B}
                          - 2 D_r \frac{1}{n_i} \frac{\partial n_i}{\partial r}
                          + 6 D_r \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                   \right) \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \nonumber \\
    &\qquad\quad - \frac{E_r}{B} \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y} \frac{\partial F_i}{\partial w_\perp} \nonumber \\
    &\qquad\quad + D_r \left( - \frac{w_\perp}{v_{Ti}} \frac{\partial^2 v_{Ti}}{\partial r^2}
                        + \frac{w_\perp}{v_{Ti}^2} \left( \frac{\partial v_{Ti}}{\partial r} \right)^2
                 \right) \nonumber \\
    &\qquad\quad\left. + D_r \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
             \right] \frac{\partial F_i}{\partial w_\perp} \nonumber \\
    &\quad + \left( \frac{1}{n_i} \frac{\partial n_i}{\partial t} + \frac{(v_{Ti} w_\parallel + u_{i\parallel})}{n_i} \frac{\partial n_i}{\partial z}
                    - \frac{3}{v_{Ti}} \frac{\partial v_{Ti}}{\partial t} - \frac{3 (v_{Ti} w_\parallel + u_{i\parallel})}{v_{Ti}} \frac{\partial v_{Ti}}{\partial z} \right . \nonumber \\
       &\qquad\quad + \frac{E_y}{B} \frac{1}{n_i} \frac{\partial n_i}{\partial r} - 3 \frac{E_y}{B} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                    - \frac{E_r}{B} \frac{1}{n_i} \frac{\partial n_i}{\partial y} + 3 \frac{E_r}{B} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y} \nonumber \\
       &\qquad\quad\left . - D_r \frac{1}{n_i} \frac{\partial^2 n_i}{\partial r^2}
                    + 6 D_r \frac{1}{n_i v_{Ti}} \frac{\partial n_i}{\partial r} \frac{\partial v_{Ti}}{\partial r}
                    + 3 D_r \frac{1}{v_{Ti}} \frac{\partial^2 v_{Ti}}{\partial r^2}
                    - 12 D_r \frac{1}{v_{Ti}^2} \left( \frac{\partial v_{Ti}}{\partial r} \right)^2
             \right) F_i \nonumber \\
...
&\frac{\partial F_i}{\partial t} + \dot{z} \frac{\partial F_i}{\partial z} + \dot{r} \frac{\partial F_i}{\partial r}
  + \dot{y} \frac{\partial F_i}{\partial y} + \dot{w}_\parallel \frac{\partial F_i}{\partial w_\parallel} + \dot{w}_\perp \frac{\partial F_i}{\partial w_\perp}
    = \dot{F}_i + \mathcal{C}_i + \frac{v_{Ti}^3}{n_i} S_i + \mathcal{D}_i \\
\end{align}
```
where
```math
...
\frac{\dot{F}_i}{F_i} &= \frac{1}{n_i} \frac{\partial n_i}{\partial t} + \frac{(v_{Ti} w_\parallel + u_{i\parallel})}{n_i} \frac{\partial n_i}{\partial z}
                        - \frac{3}{v_{Ti}} \frac{\partial v_{Ti}}{\partial t} - \frac{3 (v_{Ti} w_\parallel + u_{i\parallel})}{v_{Ti}} \frac{\partial v_{Ti}}{\partial z} \nonumber \\
           &\qquad\quad + \frac{E_y}{B} \frac{1}{n_i} \frac{\partial n_i}{\partial r} - 3 \frac{E_y}{B} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                        - \frac{E_r}{B} \frac{1}{n_i} \frac{\partial n_i}{\partial y} + 3 \frac{E_r}{B} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y} \nonumber \\
...
\mathcal{D}_i &= D_r \frac{\partial^2 F_i}{\partial r^2} \nonumber \\
         &\qquad + 2 D_r \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right) \frac{\partial^2 F_i}{\partial r \partial w_\parallel} \nonumber \\
         &\qquad - 2 D_r \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{\partial^2 F_i}{\partial r \partial w_\perp} \nonumber \\
         &\qquad + D_r \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right)^2 \frac{\partial^2 F_i}{\partial w_\parallel^2} \nonumber \\
         &\qquad - 2 D_r \left( - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right) \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \frac{\partial^2 F_i}{\partial w_\parallel \partial w_\perp} \nonumber \\
         &\qquad + D_r \left( \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \right)^2 \frac{\partial^2 F_i}{\partial w_\perp^2} \\
\end{align}
```
Defining the repeated terms
```math
\begin{align}
W_{\parallel,r} &= \left . \frac{\partial w_\parallel}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp}
                 = - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \\

W_{\perp,r} &= \left . \frac{\partial w_\perp}{\partial r} \right|_{t,y,z,v_\parallel,v_\perp}
             = - \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \\

W_{\parallel,y} &= \left . \frac{\partial w_\parallel}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp}
                 = - \frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial y} - \frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y} \\

W_{\perp,y} &= \left . \frac{\partial w_\perp}{\partial y} \right|_{t,r,z,v_\parallel,v_\perp}
             = - \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y} \\
\end{align}
```
we could express the coefficients more compactly as
```math
\begin{align}
\dot{z} &= v_{Ti} w_\parallel + u_{i\parallel} \\
...
\dot{w}_\perp &= - \left[ \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial t} + \left( w_\parallel + \frac{u_{i\parallel}}{v_{Ti}} \right) w_\perp \frac{\partial v_{Ti}}{\partial z}
                          - \dot{r} W_{\perp,r}
                          - \dot{y} W_{\perp,y} \right . \nonumber \\
             &\qquad\quad + D_r \left( - \frac{w_\perp}{v_{Ti}} \frac{\partial^2 v_{Ti}}{\partial r^2}
                                 + \frac{w_\perp}{v_{Ti}^2} \left( \frac{\partial v_{Ti}}{\partial r} \right)^2
                          \right)
...
\mathcal{D}_i &= D_r \frac{\partial^2 F_i}{\partial r^2}
                 + 2 D_r W_{\parallel,r} \frac{\partial^2 F_i}{\partial r \partial w_\parallel}
                 + 2 D_r W_{\perp,r} \frac{\partial v_{Ti}}{\partial r} \frac{\partial^2 F_i}{\partial r \partial w_\perp} \nonumber \\
         &\qquad + D_r W_{\parallel,r}^2 \frac{\partial^2 F_i}{\partial w_\parallel^2}
                 + 2 D_r W_{\parallel,r} W_{\perp,r} \frac{\partial^2 F_i}{\partial w_\parallel \partial w_\perp}
                 + D_r W_{\perp,r}^2 \frac{\partial^2 F_i}{\partial w_\perp^2} \\
\end{align}
```
...
\dot{w}_\parallel &= - \left[ \frac{1}{v_{Ti}} \left( - \cancel{u_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z}}
                                ...
                                &\qquad\qquad \left . + \frac{S_{i,\mathrm{mom}}}{m_i n_i}
                                                      - \frac{u_{i\parallel}}{n_i} S_{i,n}
                                                      + \frac{D_r}{n_i} \left( \cancel{n_i \frac{\partial^2 u_{i\parallel}}{\partial r^2}} + \cancel{2 \frac{\partial n_i}{\partial r} \frac{\partial u_{i\parallel}}{\partial r}} \right)
                                               \right) \nonumber \\
                 &\qquad\quad + \left( w_\parallel + \cancel{\frac{u_{i_\parallel}}{v_{Ti}}} \right) \frac{\partial u_{i\parallel}}{\partial z} + \cancel{\frac{e}{m_i v_{Ti}} \frac{\partial\phi}{\partial z}} \\
                 &\qquad\quad + \frac{w_\parallel}{v_{Ti}} \left( - \cancel{u_{i\parallel} \frac{\partial v_{Ti}}{\partial z}}
                                                                  - \cancel{\frac{E_y}{B} \frac{\partial v_{Ti}}{\partial r}}
                                                                  + \cancel{\frac{E_r}{B} \frac{\partial v_{Ti}}{\partial y}} \right . \nonumber \\
                                              &\qquad\qquad\qquad + \frac{2}{3 m_i n_i v_{Ti}} \left( - \frac{\partial q_{i\parallel}}{\partial z}
                                                              ...
                                                              &\qquad\qquad\qquad\qquad\qquad\qquad + \frac{1}{2} R_\mathrm{ioniz} n_e n_n \left( 3 T_n - 3 T_i + m_i (u_{i\parallel} - u_{n\parallel})^2 \right)
                                                                                                    + \frac{3}{2} S_{i,p}
                                                                                                    - \frac{3}{2} T_i S_{i,n} \nonumber \\
                                              &\qquad\qquad\qquad\qquad\qquad\qquad \left . \left . + D_r \left( \underbrace{\frac{3}{2} n_i \frac{\partial^2 T_i}{\partial r^2}}_{\cancel{\frac{3}{2} m_i n_i v_{Ti} \frac{\partial^2 v_{Ti}}{\partial r^2}} + \frac{3}{2} m_i n_i \left( \frac{\partial v_{Ti}}{\partial r} \right)^2} + \underbrace{3 \frac{\partial n_i}{\partial r} \frac{\partial T_i}{\partial r}}_{\cancel{3 m_i v_{Ti} \frac{\partial n_i}{\partial r} \frac{\partial v_{Ti}}{\partial r}}} + m_i n_i \left( \frac{\partial u_{i\parallel}}{\partial r} \right)^2 \right)
                                                                                             \right)
                                                           \right) \nonumber \\
                 &\qquad\quad + w_\parallel \left( w_\parallel + \cancel{\frac{u_{i\parallel}}{v_{Ti}}} \right) \frac{\partial v_{Ti}}{\partial z} \nonumber \\
                 &\qquad\quad + \left( \cancel{\frac{E_y}{B}}
                                       - \cancel{2 D_r \frac{1}{n_i} \frac{\partial n_i}{\partial r}}
                                       + 6 D_r \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                 ...
                 &\qquad\quad + \frac{E_r}{B} \left( - \cancel{\frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial y}} - \cancel{\frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y}} \right) \nonumber \\
                 &\qquad\quad \left. + D_r \left( - \cancel{\frac{1}{v_{Ti}} \frac{\partial^2 u_{i\parallel}}{\partial r^2}}
                                                  + \frac{1}{v_{Ti}^2} \frac{\partial v_{Ti}}{\partial r} \frac{\partial u_{i\parallel}}{\partial r}
                                                  - \cancel{\frac{w_\parallel}{v_{Ti}} \frac{\partial^2 v_{Ti}}{\partial r^2}}
                                                  + \cancel{\frac{w_\parallel}{v_{Ti}^2} \left( \frac{\partial v_{Ti}}{\partial r} \right)^2}
                                           \right)
                             + D_r \left( \cancel{\frac{1}{v_{Ti}} \frac{\partial u_{i\parallel}}{\partial r}} - \cancel{\frac{w_\parallel}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}} \right) \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                       \right] \\

\dot{w}_\perp &= - \left[ \frac{w_\perp}{v_{Ti}} \left( - \cancel{u_{i\parallel} \frac{\partial v_{Ti}}{\partial z}}
                                                        - \cancel{\frac{E_y}{B} \frac{\partial v_{Ti}}{\partial r}}
                                                        + \cancel{\frac{E_r}{B} \frac{\partial v_{Ti}}{\partial y}} \right . \right . \nonumber \\
                                    &\qquad\qquad\qquad + \frac{2}{3 m_i n_i v_{Ti}} \left(
                                                            - \frac{\partial q_{i\parallel}}{\partial z}
                                                            - p_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z}
                                                            - \frac{1}{2} R_\mathrm{CX} n_i n_n \left( 3 T_i - 3 T_n - m_i (u_{i\parallel} - u_{n\parallel})^2 \right) \right . \nonumber \\
                      &\qquad\qquad\qquad\qquad\qquad\qquad + \frac{1}{2} R_\mathrm{ioniz} n_e n_n \left( 3 T_n - 3 T_i + m_i (u_{i\parallel} - u_{n\parallel})^2 \right)
                                                            + \frac{3}{2} S_{i,p}
                                                            - \frac{3}{2} T_i S_{i,n} \nonumber \\
      &\qquad\qquad\qquad\qquad\qquad\qquad \left . \left . + D_r \left( \underbrace{\frac{3}{2} n_i \frac{\partial^2 T_i}{\partial r^2}}_{\cancel{\frac{3}{2} m_i n_i v_{Ti} \frac{\partial^2 v_{Ti}}{\partial r^2}} + \frac{3}{2} m_i n_i \left( \frac{\partial v_{Ti}}{\partial r} \right)^2} + \underbrace{3 \frac{\partial n_i}{\partial r} \frac{\partial T_i}{\partial r}}_{\cancel{3 m_i v_{Ti} \frac{\partial n_i}{\partial r} \frac{\partial v_{Ti}}{\partial r}}} + m_i n_i \left( \frac{\partial u_{i\parallel}}{\partial r} \right)^2 \right) \right)
                                                 \right) \nonumber \\
             &\qquad\quad + \left( w_\parallel + \cancel{\frac{u_{i\parallel}}{v_{Ti}}} \right) w_\perp \frac{\partial v_{Ti}}{\partial z} \nonumber \\
             &\qquad\quad + \left( \cancel{\frac{E_y}{B}}
                                   - \cancel{2 D_r \frac{1}{n_i} \frac{\partial n_i}{\partial r}}
                                   + 6 D_r \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}
                            \right) \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r} \nonumber \\
             &\qquad\quad - \cancel{\frac{E_r}{B} \frac{w_\perp}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y}}
                          + D_r \left( - \cancel{\frac{w_\perp}{v_{Ti}} \frac{\partial^2 v_{Ti}}{\partial r^2}}
                                 + \frac{w_\perp}{v_{Ti}^2} \left( \frac{\partial v_{Ti}}{\partial r} \right)^2
                          \right)
                          \left. + D_r \frac{w_\perp}{v_{Ti}^2} \left( \frac{\partial v_{Ti}}{\partial r} \right)^2
                   \right]  \\

\frac{\dot{F}_i}{F_i} &= \frac{1}{n_i} \left( - \cancel{u_{i\parallel} \frac{\partial n_i}{\partial z}}
                                              - n_i \frac{\partial u_{i\parallel}}{\partial z}
                                              - \cancel{\frac{E_y}{B} \frac{\partial n_i}{\partial r}}
                                              + \cancel{\frac{E_r}{B} \frac{\partial n_i}{\partial y}}
                                              + R_\mathrm{ioniz} n_e n_n
                                              + S_{i,n}
                                              + \cancel{D_r \frac{\partial^2 n_i}{\partial r^2}}
                                       \right) \nonumber \\
                &\qquad + \frac{(v_{Ti} w_\parallel + \cancel{u_{i\parallel}})}{n_i} \frac{\partial n_i}{\partial z} \nonumber \\
                &\qquad - \frac{3}{v_{Ti}} \left( - \cancel{u_{i\parallel} \frac{\partial v_{Ti}}{\partial z}}
                                                                  - \cancel{\frac{E_y}{B} \frac{\partial v_{Ti}}{\partial r}}
                                                                  + \cancel{\frac{E_r}{B} \frac{\partial v_{Ti}}{\partial y}} \right . \nonumber \\
                                              &\qquad\qquad\qquad + \frac{2}{3 m_i n_i v_{Ti}} \left( - \frac{\partial q_{i\parallel}}{\partial z}
                                                                                                    - p_{i\parallel} \frac{\partial u_{i\parallel}}{\partial z}
                                              ...
                                              &\qquad\qquad\qquad\qquad\qquad\qquad \left . \left . + D_r \left( \underbrace{\frac{3}{2} n_i \frac{\partial^2 T_i}{\partial r^2}}_{\cancel{\frac{3}{2} m_i n_i v_{Ti} \frac{\partial^2 v_{Ti}}{\partial r^2}} + \frac{3}{2} m_i n_i \left( \frac{\partial v_{Ti}}{\partial r} \right)^2} + \underbrace{3 \frac{\partial n_i}{\partial r} \frac{\partial T_i}{\partial r}}_{\cancel{3 m_i v_{Ti} \frac{\partial n_i}{\partial r} \frac{\partial v_{Ti}}{\partial r}}} + m_i n_i \left( \frac{\partial u_{i\parallel}}{\partial r} \right)^2 \right)
                                                                                             \right)
                                                           \right) \nonumber \\
           &\qquad\quad - \frac{3 (v_{Ti} w_\parallel + \cancel{u_{i\parallel}})}{v_{Ti}} \frac{\partial v_{Ti}}{\partial z} \nonumber \\
           &\qquad\quad + \cancel{\frac{E_y}{B} \frac{1}{n_i} \frac{\partial n_i}{\partial r}} - \cancel{3 \frac{E_y}{B} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial r}}
                        - \cancel{\frac{E_r}{B} \frac{1}{n_i} \frac{\partial n_i}{\partial y}} + 3 \cancel{\frac{E_r}{B} \frac{1}{v_{Ti}} \frac{\partial v_{Ti}}{\partial y}} \nonumber \\
           &\qquad\quad - \cancel{D_r \frac{1}{n_i} \frac{\partial^2 n_i}{\partial r^2}}
                        + \cancel{6 D_r \frac{1}{n_i v_{Ti}} \frac{\partial n_i}{\partial r} \frac{\partial v_{Ti}}{\partial r}}
                        + \cancel{3 D_r \frac{1}{v_{Ti}} \frac{\partial^2 v_{Ti}}{\partial r^2}}
                        - 12 D_r \frac{1}{v_{Ti}^2} \left( \frac{\partial v_{Ti}}{\partial r} \right)^2 \\
\end{align}
```
```@raw html
