...
packages = [:moment_kinetics, :PackageCompiler, :TimerOutputs, :NCDatasets, :FFTW, :Plots, :IJulia, :LsqFit, :OrderedCollections, :Glob, :NaturalSort, :SpecialFunctions, :Roots, :TOML]
