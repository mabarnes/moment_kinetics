    ...
    @testset "Harrison-Thompson" verbose=use_verbose begin
        ...
        @testset "Chebyshev" begin
            run_test(test_input_chebyshev, 3.e-2, 3.e-3,
                     [-0.8100717809913704, -0.6518905458208054, -0.4205847391184683,
                      -0.2829754939995388, -0.18334174436596662, -0.13595772462524092,
                      -0.1096945856838869, -0.10656269809119458, -0.10321629278973161,
                      -0.10656269809119495, -0.10969458568388714, -0.13595772462524205,
                      -0.18334174436596595, -0.2829754939995379, -0.4205847391184681,
                      -0.6518905458208045, -0.8100717809913693], 5.e-9, 1.e-15)
        end
    end
end
