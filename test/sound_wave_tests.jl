...
function run_test_set_chebyshev()
    for input ∈ (test_input_chebyshev, test_input_chebyshev_matrix_multiply)
        #n_i=n_n, T_e=1
        @long run_test(input, 2*π*1.4467, -2*π*0.6020,
                       [-0.6931471805599453, -0.6925817758085663, -0.6922515628093567,
                        -0.6921548130694323, -0.6921476802268619, -0.6921548130694323];
                       charge_exchange_frequency=2*π*0.0)
        run_test(input, 2*π*1.4240, -2*π*0.6379,
                 [-0.6931471805599453, -0.6925817758085663, -0.6922515628093567,
                  -0.6921548130694323, -0.6921476802268619, -0.6921548130694323])
        @long run_test(input, 2*π*0.0, -2*π*0.3235,
                       [-0.6931471805599453, -0.6925817758085663, -0.6922515628093567,
                        -0.6921548130694323, -0.6921476802268619, -0.6921548130694323];
                       charge_exchange_frequency=2*π*1.8)
        @long run_test(input, 2*π*0.0, -2*π*0.2963,
                       [-0.6931471805599453, -0.6925817758085663, -0.6922515628093567,
                        -0.6921548130694323, -0.6921476802268619, -0.6921548130694323];
                       charge_exchange_frequency=2*π*2.0)
        ...
        # n_i=n_n T_e=0.5
        @long run_test(input, 2*π*1.2671, -2*π*0.8033,
        ...
        @long run_test(input, 2*π*0.0, -2*π*0.2727,
                       [-0.34657359027997264, -0.34629088790428314, -0.34612578140467837,
                        -0.34607740653471614, -0.34607384011343095, -0.34607740653471614];
                       T_e=0.5, charge_exchange_frequency=2*π*2.0)

        # n_i=n_n T_e=4
        @long run_test(input, 2*π*1.9919, -2*π*0.2491,
...
function run_test_set_chebyshev_split_1_moment()
    for input ∈ (test_input_chebyshev_split_1_moment,
...
function run_test_set_chebyshev_split_2_moments()
    for input ∈ (test_input_chebyshev_split_2_moments, test_input_chebyshev_matrix_multiply_split_2_moments)
        #n_i=n_n, T_e=1
        @long run_test(input, 2*π*1.4467, -2*π*0.6020,
                       [-0.6931471805599453, -0.6925817758085663, -0.6922515628093567,
                        -0.6921548130694323, -0.6921476802268619, -0.6921548130694323];
...
function run_test_set_chebyshev_split_3_moments()
    for input ∈ (test_input_chebyshev_split_3_moments, test_input_chebyshev_matrix_multiply_split_3_moments)
        #n_i=n_n, T_e=1
        @long run_test(input, 2*π*1.4467, -2*π*0.6020,
                       [-0.6931471805599453, -0.6925817758085663, -0.6922515628093567,
                        -0.6921548130694323, -0.6921476802268619, -0.6921548130694323];
