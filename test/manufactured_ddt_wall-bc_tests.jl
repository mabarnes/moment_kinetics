...
Test just the time derivative at t=0, using wall boundary conditions in the z-direction.
"""
module ManufacturedDDTWallBCTests
...
end # ManufacturedDDTWallBCTests


using .ManufacturedDDTWallBCTests

ManufacturedDDTWallBCTests.runtests()
