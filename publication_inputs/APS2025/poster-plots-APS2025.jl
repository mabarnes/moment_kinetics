...
AT = 0.1
periodic5_run_dirs = (("runs/2D1V-instability-periodic-Lz0.02-test-Fourier-r-AT0.1-An0.0/", 0.0),
                      ...
                      ("runs/2D1V-instability-periodic-Lz0.02-test-Fourier-r-AT0.1-An0.05/", 0.05),
...
Tpar = get_variable(ri_periodic5[1][1], "parallel_pressure"; it=1, is=1, ir=1) ./ get_variable(ri_periodic5[1][1], "density"; it=1, is=1, ir=1)
lines!(ax_bg, ri_periodic5[1][1].z.grid, Tpar)
save(joinpath(dir_periodic5_Fourier_r, "periodic_Lz0.02_Fourier-r_background_Tpar.png"), fig_bg; px_per_unit=resolution_increase_factor)
...
Legend(fig_bg[2,1], ax_bg; tellheight=true, tellwidth=false)
resize_to_layout!(fig_bg)
save(joinpath(dir_periodic5_Fourier_r, "periodic_Lz0.02_Fourier-r_background_n.png"), fig_bg; px_per_unit=resolution_increase_factor)

xlims!(ax, 0.0, 20.0)
Legend(fig[2,1], ax; tellheight=true, tellwidth=false)
resize_to_layout!(fig)
save(joinpath(dir_periodic5_Fourier_r, "growth_rate_periodic_Lz0.02_Fourier-r-AT$(AT)-An-scan.png"), fig; px_per_unit=resolution_increase_factor)
...
save(joinpath(dir_periodic5_Fourier_r, "Fourier-r_Lz0.02_growth_rate_vs_LToverLn.png"), fig; px_per_unit=resolution_increase_factor)
