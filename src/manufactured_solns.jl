...
import LambertW: lambertw
    ...
    function manufactured_sources(r_coord,z_coord,vperp_coord,vpa_coord,vzeta_coord,vr_coord,vz_coord,composition,geometry,collisions,num_diss_params)
        ...
        densi = densi_sym(r_coord.L,z_coord.L,r_coord.bc,z_coord.bc,composition,r_coord.n,z_coord.n)
        dfni = dfni_sym(r_coord.L,z_coord.L,r_coord.bc,z_coord.bc,composition,geometry,r_coord.n,z_coord.n)
        vrvzvzeta_dfni = cartesian_dfni_sym(r_coord.L,z_coord.L,r_coord.bc,z_coord.bc,composition,r_coord.n,z_coord.n) #dfni in vr vz vzeta coordinates
