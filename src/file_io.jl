...
function setup_netcdf_io(prefix, z, vpa, composition, collisions, evolve_ppar)
    ...
    return netcdf_info{4,3,2}(fid, cdf_time, cdf_f, cdf_phi, cdf_density, cdf_upar,
