...
test_input_finite_difference = OptionsDict("composition" => OptionsDict("n_ion_species" => 1,
                                           ...
                                           "z_IC_ion_species_1" => OptionsDict("initialization_option" => "sinusoid",
                                                                               ...
                                                                               "temperature_phase" => Float64(π)),
                                           "z_IC_neutral_species_1" => OptionsDict("initialization_option2" => "sinusoid",
                                                                                   "density_amplitude" => 0.5,
                                           ...
                                           "r" => OptionsDict("ngrid" => 1,
                                                              "nelement" => 1),
                                           "z" => OptionsDict("ngrid" => 161,
                                                              "nelement" => 1,
                                                              "bc" => "periodic",
                                                              "discretization" => "finite_difference"),
                                           "vpa" => OptionsDict("ngrid" => 481,
                                                                "nelement" => 1,
                                                                "L" => vpa_L,
                                                                "bc" => "periodic",
                                                                "discretization" => "finite_difference"),
                                           "vz" => OptionsDict("ngrid" => 481,
                                                               "nelement" => 1,
                                                               "L" => vpa_L,
                                                               "bc" => "periodic",
                                                               "discretization" => "finite_difference"),
