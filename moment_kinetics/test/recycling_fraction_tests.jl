...
test_input_split3 = recursive_merge(test_input_split2,
                                    OptionsDict("output" => OptionsDict("run_name" => "split3"),
                                                ...
                                                "ion_numerical_dissipation" => OptionsDict("force_minimum_pdf_value" => 0.0, "vpa_dissipation_coefficient" => 0.028284271247461905),
                                                "neutral_numerical_dissipation" => OptionsDict("force_minimum_pdf_value" => 0.0, "vz_dissipation_coefficient" => 0.028284271247461905)))
...
test_input_adaptive_split3 = recursive_merge(test_input_adaptive_split2,
                                             OptionsDict("output" => OptionsDict("run_name" => "adaptive split3"),
                                                         ...
                                                         "ion_numerical_dissipation" => OptionsDict("force_minimum_pdf_value" => 0.0,
                                                                                                    "vpa_dissipation_coefficient" => 0.028284271247461905),
    ...
    @testset "Recycling fraction" verbose=use_verbose begin
        ...
        @long @testset "Split 3" begin
            ...
            run_test(test_input_split3,
                     [-0.03620087879988501, -0.030490180205198836, -0.028973542559469764,
                      -0.0285653777639142, -0.02551261789607925, -0.02196769940622309,
                      -0.019842617741796218, -0.013329779101425155, -0.009866770628350903,
                      -0.005274826947523329, 0.002154789011036102, 0.0046037610536470526,
                      0.01149487214150717, 0.017553283878912473, 0.020142044532848298,
                      0.02711276853613633, 0.03049554385474796, 0.03404000880239125,
                      0.039318193567585084, 0.040888758317111924, 0.04435715110957028,
                      0.045819506535045074, 0.045697613485713724, 0.043116246100830646,
                      0.040540454803423866, 0.037865658629321376, 0.03223020961064269,
                      0.030099288923708997, 0.024820508626242452, 0.018584186306312984,
                      0.016208717792595546, 0.008758072852219672, 0.00399916127625425,
                      2.623847057103624e-5, -0.007645789846458956, -0.010283807832843356,
                      -0.015551236303241997, -0.02119210909307919, -0.022797461864032226,
                      -0.02689928625120462, -0.028756212978554532, -0.029230855320717772,
                      -0.0323168190380228])
        end
        ...
        @testset "Adaptive timestep - split 3" begin
            ...
            run_test(test_input_adaptive_split3,
                     [-0.03461912118846239, -0.03200156420293205, -0.027137273387556213,
                      -0.020922852745094398, -0.010149949186145217, 0.0027882067211980714,
                      0.012835497294863371, 0.022092829247788992, 0.033030220519704896,
                      0.04152780346735807, 0.045380292815454214, 0.04624532131350382,
                      0.04254832104017345, 0.03481046544647244, 0.027076581063082295,
                      0.01788345787421166, 0.004783037568764046, -0.007761850514307747,
                      -0.016291828443397115, -0.024131659953586376, -0.03155864050707645,
                      -0.03416518801516782], rtol=6.0e-4, atol=2.0e-12)
        end
