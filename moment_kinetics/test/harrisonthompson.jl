...
# Make split2 timestep shorter because run seems to be unstable
test_input_chebyshev_split2["timestepping"]["dt"] = 1.0e-4
test_input_chebyshev_split2["timestepping"]["nstep"] = 50000
test_input_chebyshev_split2["timestepping"]["nwrite"] = 50000
...
function runtests()
    ...
    @testset "Harrison-Thompson" verbose=use_verbose begin
        ...
        @testset "Chebyshev split 2" begin
            ...
            run_test(test_input_chebyshev_split2, 4.0e-2,
                     [-0.8508051085051793, -0.786811504203178, -0.6478895394163212,
                      -0.5222036914649071, -0.43221210057184833, -0.36568685684887464,
                      -0.3193433239446189, -0.2944704709806245, -0.28367291243521386,
                      -0.25574790629567673, -0.20478145128122127, -0.151846893718212,
                      -0.11632578892298966, -0.09100308783524867, -0.07920028392956556,
                      -0.07867671591412141, -0.07742649984136978, -0.07867666709978653,
                      -0.07920021788015394, -0.09100319753955999, -0.11632565251146731,
                      -0.15184706655872074, -0.2047814068986766, -0.25574731586261523,
                      -0.28367244806937825, -0.29447034010178996, -0.31934474050072226,
                      -0.365686373616658, -0.43221205553634995, -0.5222038332887754,
                      -0.6478856847005102, -0.7868099237033578, -0.85080674837218],
                      1.0e-9)
        end
