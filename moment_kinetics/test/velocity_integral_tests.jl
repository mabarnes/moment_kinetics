...
function runtests()
    @testset "velocity integral tests" verbose=use_verbose begin
        ...
        vpa, vpa_spectral = define_coordinate(vpa_input, nothing; ignore_MPI=true)
        vperp, vperp_spectral = define_coordinate(vperp_input, nothing; ignore_MPI=true)
        vz, vz_spectral = define_coordinate(vz_input, nothing; ignore_MPI=true)
        vr, vr_spectral = define_coordinate(vr_input, nothing; ignore_MPI=true)
