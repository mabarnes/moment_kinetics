...
function runtests(; highres=false)
    @testset "Fokker Planck dFdt = C[F,F] relaxation test" verbose=use_verbose begin
        ...
        @long push!(test_cases, (true, false, false, highres ? 2.0e-8 : 2.0e-14, highres ? 2.0e-8 : 1.0e-14, highres ? 4.0e-3 : 1.0e-5, highres ? 1.0e-4 : 5.0e-12, highres ? 4.0e-3 : 1.0e-5))
        @long push!(test_cases, (true, true, false, highres ? 2.0e-3 : 2.0e-14, highres ? 3.0e-4 : 2.0e-14, highres ? 4.0e-3 : 1.0e-5, highres ? 3.0e-4 : 5.0e-12, highres ? 4.0e-3 : 1.0e-5))
