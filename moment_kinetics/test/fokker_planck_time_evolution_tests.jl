...
const expected_zero_impose_regularity =
  expected_data(
    # Expected vpa
    sqrt(2) .* [-3.000000000000000, -2.500000000000000, -2.000000000000000, -1.500000000000000, -1.000000000000000, -0.500000000000000, 0.000000000000000, 0.500000000000000, 1.000000000000000, 1.500000000000000, 2.000000000000000, 2.500000000000000, 3.000000000000000],
    # Expected vperp
    ...
    # Expected upar_ion
    sqrt(2) .* [0.127188034386486, 0.127125252973134],
    # Expected ppar_ion
    2.0 .* [0.156668641253299, 0.501846847278676],
    # Expected pperp_ion
    2.0 .* [0.719549591157190, 0.535875941382659],
    # Expected qpar_ion
    sqrt(2) .* [-0.019194164922596, -0.007216264716710],
    # Expected v_t_ion
    sqrt(2) .* [1.021755168637407, 1.034087075929172],
    # Expected dSdt_ion
    sqrt(2) .* [0.000000000000000, 0.000164440610574],
    # Expected maxnorm_ion
    (1.0 / (2.0 * π)^1.5) .* [0.808346186957451, 0.179973032115546],
    # Expected L2norm_ion
    (1.0 / (2.0 * π)^1.5) .* [0.087661894753377, 0.011357320066030],
    # Expected f_ion
...
expected_data(
    ...
    # Expected upar_ion
    sqrt(2) .* [0.127188034386486, 0.127188034386492],
    # Expected ppar_ion
    2.0 .* [0.153743686448806, 0.530406198086908],
    # Expected pperp_ion
    2.0 .* [0.719320904338625, 0.530989648519366],
    # Expected qpar_ion
    sqrt(2) .* [-0.018835815833337, -0.003341501709899],
    # Expected v_t_ion
    sqrt(2) .* [1.030335090859288, 1.030335090859291],
    # Expected dSdt_ion
    sqrt(2) .* [0.000000000000000, -0.000000000001616],
    # Expected maxnorm_ion
    (1.0 / (2.0 * π)^1.5) .* [0.818237925050035, 0.106008532902116],
    # Expected L2norm_ion
    (1.0 / (2.0 * π)^1.5) .* [0.091263900048123, 0.007627575466069],
    # Expected f_ion
    (1.0 / (2.0 * π)^1.5) .* [0.000000000000000 0.000000000000000 0.000000000000000 0.000000000000000 0.000000000000000 0.000000000000000 0.000000000000000 ;
...
expected_data(
    ...
    # Expected upar_ion
    sqrt(2) .* [0.127188034386488, 0.127188034386486],
    # Expected ppar_ion
    2.0 .* [0.153743696495533, 0.523721622597214],
    # Expected pperp_ion
    2.0 .* [0.719321198401106, 0.534332235350059],
    # Expected qpar_ion
    sqrt(2) .* [-0.018835817064195, -0.003073200116913],
    # Expected v_t_ion
    sqrt(2) .* [1.030335250714622, 1.030335250714620],
    # Expected dSdt_ion
    sqrt(2) .* [0.000000000000000, 0.000000000000006],
    # Expected maxnorm_ion
    (1.0 / (2.0 * π)^1.5) .* [0.818237961233122, 0.011544489536890],
    # Expected L2norm_ion
    (1.0 / (2.0 * π)^1.5) .* [0.091263890321732, 0.001724403977964],
    # Expected f_ion
    (1.0 / (2.0 * π)^1.5) .* [0.000000000000000 0.000000000000000 0.000000000000000 0.000000000000000 0.000000000000000 0.000000000000000 0.000000000000000 ;
    0.000000000000126 0.000000000001327 0.000000000002198 0.000000000000808 0.000000000000040 0.000000000000000 0.000000000000000 ;
