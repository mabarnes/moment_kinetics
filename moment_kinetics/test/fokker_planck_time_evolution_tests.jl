...
const expected_zero_impose_regularity =
  expected_data(
   ...
   # Expected dSdt
   (sqrt(2) / π^1.5) .* [0.0, 1.1831920390587679e-5],
   # Expected f_ion:
...
expected_data(
   ...
   # Expected dSdt
   (sqrt(2) / π^1.5) .* [0.000000000000000, -0.000000000865997],
   # Expected f_ion:
...
expected_data(
   ...
   # Expected dSdt
   (sqrt(2) / π^1.5) .* [0.000000000000000, 0.000000019115425],
   # Expected f_ion:
