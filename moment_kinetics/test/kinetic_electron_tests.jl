...
boltzmann_input = OptionsDict(
    ...
    "composition" => OptionsDict("T_e" => 0.13333333333333333,
                                 "n_ion_species" => 1,
                                 "n_neutral_species" => 0,
                                ),
    "ion_species_1" => OptionsDict("initial_temperature" => 0.13333333333333333,
                                   "initial_density" => 1.0,
                                  ),
    ...
    for (this_kinetic_input, label, tol) ∈ ((deepcopy(kinetic_input), "", 1.0e-6),
        ...
        for adi_precon_iterations ∈ adi_precon_iterations_values
            ...
            if global_rank[] == 0
                ...
                expected_vthe = sqrt(2/3) .* [22.701784256179806 22.540907418266773;
