...
function runtests()
    ...
    expected_p = 2.0 / 3.0 .* [0.4472667753573, 0.44586573052015466, 0.4424647096166432,
    ...
    expected_q = 2*sqrt(2)/3 * [0.6773526451128238, 0.670583999021797, 0.6493886936653975,
    ...
    expected_vt = sqrt(2/3) * [60.351816207604635, 60.31012015049677, 60.200604221763534,
