...
test_input = OptionsDict("composition" => OptionsDict("n_ion_species" => 1,
                         ...
                         "ion_numerical_dissipation" => OptionsDict("force_minimum_pdf_value" => 0.0,
                                                                    "vpa_dissipation_coefficient" => 2.8284271247461903),
                         "neutral_numerical_dissipation" => OptionsDict("force_minimum_pdf_value" => 0.0,
                                                                        "vz_dissipation_coefficient" => 0.28284271247461906))
...
function runtests()
    ...
    expected_p = 2.0 .* [0.4495141154262702, 0.44810731623424865, 0.4446924860674211,
    ...
    expected_q = sqrt(2) * [0.6827418582524897, 0.6759389228503324, 0.6546242399054403,
    ...
    expected_vt = sqrt(2/3) * [60.503243776596165, 60.46153023170041, 60.35196357745784,
