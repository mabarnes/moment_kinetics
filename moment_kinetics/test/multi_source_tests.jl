...
test_input_3 = recursive_merge(test_input,
                               OptionsDict("output" => OptionsDict("run_name" => "PI_controller_sources_moments"),
                                           "ion_source_1" => OptionsDict("active" => true,
                                                                         ...
                                                                         "PI_temperature_controller_I" => 7.0710678118654755,
                                                                         "PI_temperature_controller_P" => 7.0710678118654755,
                                                                         "PI_temperature_target_amplitude" => 0.6666666666666666),
                                           "ion_source_2" => OptionsDict("active" => true,
                                                                         "z_profile" => "wall_exp_decay",
                                                                         "z_width" => 0.15,
                                                                         "source_strength" => 5.0,
