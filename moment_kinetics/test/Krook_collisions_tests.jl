...
const expected =
    (
     ...
     n_ion=[0.2500030702177186 0.28989452952580286; 0.2977473631375158 0.32283464906590775;
     ...
     upar_ion=sqrt(2) .* [-2.7135787559953277e-17 -1.6845791254993525e-16; -9.321028970172899e-18 -0.18245939812953485;
     ...
     upar_neutral=sqrt(2) .* [6.5569385065066925e-18 8.08747058038406e-18; 1.1054500872839027e-17 -0.03620988455458174;
     ...
     ppar_ion=2 .* [0.18749999999999992 0.23302732230115558; 0.20909325514551116 0.21936799130257528;
     ...
     ppar_neutral=2 .* [0.18750000000000003 0.2480292382671593; 0.20909325514551122 0.24401255100297964;
     ...
     f_ion=(1 / sqrt(2 * π)) .* [0.0370462360994826 0.04059927063892091 0.0428431419871786 0.030398267195914062 0.01236045902698859 0.006338529470383425 0.012360459026988587 0.030398267195914028 0.04284314198717859 0.0405992706389209 0.0370462360994826;
     ...
     f_neutral=(1 / sqrt(2 * π)) .* [0.0063385294703834595 0.012360459026988546 0.030398267195914108 0.04284314198717859 0.040599270638920985 0.03704623609948259 0.040599270638920965 0.0428431419871786 0.030398267195914094 0.012360459026988546 0.006338529470383456;
