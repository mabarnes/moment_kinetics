...
function create_moments_ion(z, r, n_species, evolve_density, evolve_upar,
    ...
    if evolve_density && num_diss_params.ion.moment_dissipation_coefficient > 0.0
        ...
        d2dens_dr2 = allocate_shared_float(; z=z, r=r, ion_species=n_species)
    else
        d2dens_dz2 = nothing
        d2dens_dr2 = nothing
    end
    ...
    if evolve_upar && num_diss_params.ion.moment_dissipation_coefficient > 0.0
        ...
        d2upar_dr2 = allocate_shared_float(; z=z, r=r, ion_species=n_species)
    else
        d2upar_dz2 = nothing
        d2upar_dr2 = nothing
    end
    ...
    if evolve_p
        ...
        d2p_dr2 = allocate_shared_float(; z=z, r=r, ion_species=n_species)
