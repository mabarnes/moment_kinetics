...
@timeit global_timer setup_moment_kinetics(
    ...
    if write_output
        # setup i/o
        ascii_io, io_moments, io_dfns = setup_file_io(io_input, vz, vr, vzeta, vpa, vperp,
            z, r, composition, collisions, moments.evolve_density, moments.evolve_upar,
            moments.evolve_p, external_source_settings, input_dict, restart_time_index,
