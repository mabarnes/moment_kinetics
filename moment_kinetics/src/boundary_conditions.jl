...
function enforce_neutral_r_boundary_condition!(
    ...
    if r.nelement_global > r.nelement_local
        ...
        reconcile_element_boundaries_MPI!(f, end1, end2, buffer1, buffer2, r, true)
        ...
        reconcile_element_boundaries_MPI!(density, end1, end2, buffer1, buffer2, r, true)
        @loop_sn_z isn iz begin
            moment_end1[iz,isn] = uz[iz,1,isn]
            moment_end2[iz,isn] = uz[iz,nr,isn]
        end
        reconcile_element_boundaries_MPI!(uz, end1, end2, buffer1, buffer2, r, true)
        @loop_sn_z isn iz begin
            moment_end1[iz,isn] = p[iz,1,isn]
            moment_end2[iz,isn] = p[iz,nr,isn]
        end
        reconcile_element_boundaries_MPI!(p, end1, end2, buffer1, buffer2, r, true)
    end
...
function enforce_neutral_z_boundary_condition!(pdf, density, uz, pz, moments, density_ion,
    ...
    if z.nelement_global > z.nelement_local
        ...
        reconcile_element_boundaries_MPI!(pdf, end1, end2, buffer1, buffer2, z, true)
    end
