...
function setup_advance_flags(moments, composition, t_input, collisions,
    ...
    if !t_input.split_operators
        ...
        if collisions.fkpl.nuii > 0.0 && collisions.fkpl.use_fokker_planck && vperp.n > 1 
        ...
        if collisions.krook.krook_collision_frequency_prefactor > 0.0 && collisions.krook.use_krook
