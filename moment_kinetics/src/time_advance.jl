...
function get_nl_solver_params(t_params, input_dict, composition, r, z, vperp, vpa,
    ...
    if t_params.use_implicit_ion_fp_collisions
        nl_solver_ion_fp_collisions = setup_fp_nl_solve(input_dict, (vperp=vperp, vpa=vpa))
    else
        nl_solver_ion_fp_collisions = nothing
    end
