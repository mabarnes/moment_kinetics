...
test_input = Dict("composition" => Dict("n_ion_species" => 1,
                                        "n_neutral_species" => 1,
                  ...
                  "z_IC_ion_species_1" => Dict("density_amplitude" => 0.001,
                                               "density_phase" => 0.0,
                                               "upar_amplitude" => 1.0,
                                               "upar_phase" => 0.0,
                  ...
                  "vpa_IC_ion_species_1" => Dict("initialization_option" => "gaussian",
                                               ...
                                               "temperature_amplitude" => 0.0,
                                               "temperature_phase" => 0.0),
                  "neutral_species_1" => Dict("initial_density" => 1.0,
                                          "initial_temperature" => 1.0),
                  "z_IC_neutral_species_1" => Dict("initialization_option" => "gaussian",
                                                   ...
                                                   "temperature_amplitude" => 0.0,
                                                   "temperature_phase" => 0.0),
                  "vpa_IC_neutral_species_1" => Dict("initialization_option" => "gaussian",
                                                     "density_amplitude" => 1.0,
                                                     "density_phase" => 0.0,
                                                     "upar_amplitude" => 0.0,
                                                     "upar_phase" => 0.0,
